...
class TestNotifier(unittest.TestCase):
    @patch("md_nugget_notifier.notifier.shutil.which", return_value=None)
    ...
    @patch("md_nugget_notifier.notifier.platform.system", return_value="Darwin")
    @patch("md_nugget_notifier.notifier.subprocess.run")
    ...
    @patch("md_nugget_notifier.notifier.platform.system", return_value="Linux")
    @patch("md_nugget_notifier.notifier.shutil.which", side_effect=lambda bin_name: "/usr/bin/zenity" if bin_name == "zenity" else None)
    @patch("md_nugget_notifier.notifier.subprocess.run")
